...
## 디자인 기획
<img width="1407" height="867" alt="스크린샷 2026-02-25 오후 3 25 31" src="https://github.com/user-attachments/assets/8cb76692-6f93-4814-bc63-1b896b019a87" />
...
| 유서현 | 이번 프로젝트에서 git flow 전략, 충돌, merge 시 rebase, 심지어는 파일을 다 날려버리는 등 다양한 문제를 겪었다. 내가 아직 git 지식이 부족함을 깨닫고 제대로 배울 수 있었다. 또한, 팀원분들과 소통을 통해 문제를 해결하면서 협업의 의미도 체감했다. |
